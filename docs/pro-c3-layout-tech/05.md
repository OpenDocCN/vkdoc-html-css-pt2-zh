...
CSS 灵活的框布局模块解决了一个定位问题，这个问题是 web 设计者从 CSS 诞生的第一天起就一直在努力解决的:沿水平或垂直轴均匀地间隔元素，而不需要求助于复杂的浮动或基于脚本的技巧。这一章将更详细地介绍灵活的框布局模块，并展示它如何革新你设计网页的方式。
...
![A320135_1_En_5_Fig1_HTML.jpg](A320135_1_En_5_Fig1_HTML.jpg)
...
浏览器支持灵活的框布局已经很不错了。Internet Explorer 从版本 10 开始就部分支持该规范，IE11 中包含了完全支持。Firefox、Chrome、Safari 和 Opera 都至少部分支持该规范，基于 WebKit 的浏览器提供完全支持。
...
在灵活框布局模块的开发过程中，一些浏览器实现了该规范的早期版本。语法已经改变了。因此，Web 上的许多示例现在都已经过时了，所以在遵循示例代码时要小心，以确保您使用的是模块的正确版本。
...
图 [5-2](#Fig2) 展示了我在讨论 Flexbox 时使用的不同轴和命名约定。你可能想回头参考这个图，直到你对两个轴的概念感到舒服为止。

![A320135_1_En_5_Fig2_HTML.jpg](A320135_1_En_5_Fig2_HTML.jpg)
...
![A320135_1_En_5_Fig3_HTML.jpg](A320135_1_En_5_Fig3_HTML.jpg)
...
![A320135_1_En_5_Fig4_HTML.jpg](A320135_1_En_5_Fig4_HTML.jpg)
...
![A320135_1_En_5_Fig5_HTML.jpg](A320135_1_En_5_Fig5_HTML.jpg)
...
`flex-direction`用于定义一个柔性容器的主轴。回想一下，灵活框布局是一个二维布局模块，因此只有两个轴可供选择:
...
![A320135_1_En_5_Fig6_HTML.jpg](A320135_1_En_5_Fig6_HTML.jpg)
...
![A320135_1_En_5_Fig7_HTML.jpg](A320135_1_En_5_Fig7_HTML.jpg)
...
![A320135_1_En_5_Fig9_HTML.jpg](A320135_1_En_5_Fig9_HTML.jpg)

图 5-9。

When `flex-basis` is set with a value of `auto` or a width greater than `0`, only the extra space is distributed

![A320135_1_En_5_Fig8_HTML.jpg](A320135_1_En_5_Fig8_HTML.jpg)
...
![A320135_1_En_5_Fig10_HTML.jpg](A320135_1_En_5_Fig10_HTML.jpg)
...
![A320135_1_En_5_Fig11_HTML.jpg](A320135_1_En_5_Fig11_HTML.jpg)
...
![A320135_1_En_5_Fig12_HTML.jpg](A320135_1_En_5_Fig12_HTML.jpg)
...
![A320135_1_En_5_Fig14_HTML.jpg](A320135_1_En_5_Fig14_HTML.jpg)

图 5-14。

The same navigation bar with `flex: auto` applied to the flex items

![A320135_1_En_5_Fig13_HTML.jpg](A320135_1_En_5_Fig13_HTML.jpg)
...
![A320135_1_En_5_Fig15_HTML.jpg](A320135_1_En_5_Fig15_HTML.jpg)
...
![A320135_1_En_5_Fig16_HTML.jpg](A320135_1_En_5_Fig16_HTML.jpg)
...
![A320135_1_En_5_Fig17_HTML.jpg](A320135_1_En_5_Fig17_HTML.jpg)
...
我不能放过一个关于 Flexbox 的章节而不提供一个 Flexbox 的实际例子。下面的示例只是一个可能的使用场景，它结合了您在前面几页中看到的许多属性。如果你还不相信灵活的框布局模块的能力和灵活性，我敢肯定这个例子会说服你。

## 真实世界的例子

这个例子为一个虚构的房地产公司创建了一个页面设计模型，如图 [5-18](#Fig18) 所示。该示例使用 Flexbox 来呈现几个布局部分。

![A320135_1_En_5_Fig18_HTML.jpg](A320135_1_En_5_Fig18_HTML.jpg)
...
这段代码中的两个简单规则创建了将搜索表单推到导航区域右侧所需的布局。你可以看到图 [5-19](#Fig19) 中的输出，它是在 Chrome 30 中渲染的。

![A320135_1_En_5_Fig19_HTML.jpg](A320135_1_En_5_Fig19_HTML.jpg)
...
![A320135_1_En_5_Fig20_HTML.jpg](A320135_1_En_5_Fig20_HTML.jpg)
...
![A320135_1_En_5_Fig21_HTML.jpg](A320135_1_En_5_Fig21_HTML.jpg)
...
![A320135_1_En_5_Fig22_HTML.jpg](A320135_1_En_5_Fig22_HTML.jpg)
...
![A320135_1_En_5_Fig23_HTML.jpg](A320135_1_En_5_Fig23_HTML.jpg)
...
需要一些额外的非 Flexbox CSS 代码来定义如图 [5-18](#Fig18) 到 [5-23](#Fig23) 所示的颜色、边框和印刷样式。

## 摘要

CSS 灵活的框布局提供了一个非常多才多艺的布局模型，非常适合创建响应用户界面元素。该模块使用基于轴的范例，它的内容可以根据通过`flex-`属性集定义的一些简单规则沿着轴伸缩。
