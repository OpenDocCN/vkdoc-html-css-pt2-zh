...
![image](images/sq.jpg) **注意**一些你可能想加入书签的链接。
...
![image](images/sq.jpg) **注** `www.apress.com/9781430249832`或`http://codefoster.com/cssbookcode`
...
![image](images/sq.jpg) **注** `codeshow.codeplex.com`
...
![image](images/sq.jpg) **注** `w3.org/style/css`
...
![image](images/sq.jpg) **注** `http://msdn.microsoft.com/en-us/library/ie/ms531209(v=vs.85).aspx`
...
![image](images/sq.jpg) **注** `css-tricks.com`
...
![image](images/sq.jpg) **注** `webplatform.org`
...
![image](images/sq.jpg) **注** `lesscss.org`
...
[列出 A-1](#list1) 展示了实际颜色——`rgb(71,82,49)`——是如何只定义一次的。如果在将来的某个时候，我们的设计师通知我们，这个色调应该调整一点，它只需要在一个地方完成。
...
![image](images/sq.jpg) **注**`cssflavor.com``csscollection.com``csselite.com``csstemplates.net`
