...
您可能已经注意到，这种表示法用骆驼大小写替换了带连字符的部分名称，并使用了一种更好的命名约定，不会与 HTML 重叠。更新我们的 HTML 示例可能会给出类似清单 [9-5](#PC8) 中的代码。
...
[T2`https://jigsaw.w3.org/css-validator/validator`](https://jigsaw.w3.org/css-validator/validator)
