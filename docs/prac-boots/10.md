...
让我们从一个带菜单的长 HTML 页面开始(清单 [10-1](#PC1) )。
...
该页面引用自定义 JavaScript 的本地`javascripts/main.js`文件。暂时把这个当做空的。它还引用自定义 CSS 的本地`stylesheets/main.css`文件。把那个也当成空的。如果您保存前一页的内容并将其加载到您的浏览器上，您将看到以下内容(图 [10-1](#Fig1) )。

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig1_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig1_HTML.jpg)
...
如果您保存前面的代码并在浏览器上重新加载页面，那么您将能够看到页面的顶部内容，而不会被导航栏隐藏(图 [10-2](#Fig2) )。

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig2_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig2_HTML.jpg)

图 10-2

顶部内容可见的长页面

这个页面的另一个问题也是我在上一本书 [*大师 HTML & CSS*](https://leanpub.com/master-html-and-css) 第 [23 章](https://doi.org/10.1007/978-1-4842-6071-5_23)“定位”中处理过的问题，就是当你点击菜单项时导航栏所覆盖的内容的问题。例如，点击菜单项`State Constitutions`。你会看到下面的图(图 [10-3](#Fig3) )。

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig3_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig3_HTML.jpg)
...
您可以通过将下面的`padding-top`和`margin-top` CSS 属性添加到`h1`和`h2`元素来解决这个问题，这两个元素是页面的 HTML 元素，带有菜单项链接到的锚点(清单 [10-2](#PC3) )。
...
如果您将前面的代码保存在您的`stylesheets/main.css`文件中，并在您的浏览器上重新加载该页面，点击`State Constitutions`将显示如下(图 [10-4](#Fig4) )。

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig4_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig4_HTML.jpg)

图 10-4

单击菜单项时，内容不被覆盖

然而，当点击`More`菜单项时，你希望页面将它的内容放在顶部。这种情况现在没有发生(图 [10-5](#Fig5) )。

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig5_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig5_HTML.jpg)
...
添加`margin-bottom: 900px;`。保存 CSS 文件并在浏览器上重新加载页面。点击`More`菜单项，会出现如下画面(图 [10-6](#Fig6) )。

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig7_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig7_HTML.jpg)

图 10-7

指向各节开头的菜单项

![../images/497763_1_En_10_Chapter/497763_1_En_10_Fig6_HTML.jpg](../images/497763_1_En_10_Chapter/497763_1_En_10_Fig6_HTML.jpg)
...
1.  您的菜单项指向与这些部分的开头相对应的 id。再次查看导航栏中带有菜单项的 HTML 片段(图 [10-7](#Fig7) ):
...
然后更新`javascripts/main.js`文件，使内容如清单 [10-3](#PC11) 所示。
