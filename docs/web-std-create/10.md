...
![Accessible Sliding Navigation](Images/U1001.png)
...
![The footer from Derek Powazek's blog. More than your average footer, Derek's is designed to be useful and provide the visitor with more context and blog-related functionality.](Images/1001.png)
...
![Wireframe of the sliding navigation functionality](Images/1002.png)

**图 10.2。滑动导航功能的线框**

![The initial state of the navigation, content, and additional navigational panes in their default positions](Images/1003.png)
...
![The "exposed" state, when one of the navigational panes is in its new position, visually just below the main navigation](Images/1004.png)
...
![Adding sliding behaviors](Images/U1002.png)
...
![Flexible sizing allows for the fonts and the navigational pane itself to be resized, without breaking the design.](Images/1005.png)
...
![Using the link functionality in Dragon NaturallySpeaking to select the navigational links](Images/1006.png)
...
![When the navigational pane opens, the links contained within the pane are not available using the links array. The user would be required to say the command "link" again to repopulate the array, as seen here.](Images/1007.png)
...
![The visual artifacts of the links array. When using DOM scripting effects to move or generate content within the page, the links array does not automatically update. It requires the user to update it manually by giving the appropriate command, such as "link."](Images/1008.png)
