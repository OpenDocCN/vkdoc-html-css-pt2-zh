...
[图 1-9](img/ch01.html#two_jagged_background_images_are "Figure 1.9. Two jagged background images are used for the two differently sized level 2 headings.") 显示了用于两个`<h2>`元素的两个背景图像。
