...
如果点击`OK`按钮，将只打印页面的一部分。在这个例子中，它是第二部分，正如 Firefox 中的打印预览功能所展示的那样(见[图 8-5](#the_functionality_to_print_one "Figure 8.5. The functionality to print one section is working!") )。
