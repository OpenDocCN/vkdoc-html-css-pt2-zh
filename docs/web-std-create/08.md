...
![Print Magic: Using the DOM and CSS to Save the Planet](Images/U0801.png)
...
[图 8-1](#sectioning_the_page_comma_ready_for "Figure 8.1. Sectioning the page, ready for printing") 显示了这个虚拟页面。

![Sectioning the page, ready for printing](Images/0801.png)
...
3.  在浏览器中调出`Print`对话框，如图[图 8-2](#the_print_dialog "Figure 8.2. The Print dialog box appears before printing.") 所示。不幸的是，要避免这一步并让它直接*印刷是不可能的。用户仍然可以再单击一个按钮。在图 8-2 中[的 Firefox 示例中，是`OK`按钮。](#the_print_dialog "Figure 8.2. The Print dialog box appears before printing.")*
    ...
    ![The Print dialog box appears before printing.](Images/0802.png)
...
警报看起来像[图 8-3](#the_alert_placeholder_in_action "Figure 8.3. The alert placeholder in action") 。

![The alert placeholder in action](Images/0803.png)
...
![The finished prototype page](Images/0804.png)
...
![The functionality to print one section is working!](Images/0805.png)
...
![Resetting the display using a mouseover event that detects if the user gravitates towards the browser's print button](Images/0806.png)
...
![The finished prototype page, with refinements made](Images/0807.png)
...
![As you can see, it's a long page!](Images/0808.png)
...
![The print link design](Images/0809.png)
...
![The two appproaches to creating the link buttons](Images/0810.png)
...
![The effect of scaling up to maximum size in Internet Explorer when text sits on top of a button](Images/0811.png)
...
![The background image and button used to style the print links](Images/0812.png)
...
![The finished web page](Images/0813.png)
